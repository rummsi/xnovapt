...
$lang['info'][1]['description']   = "Le Metal sert à la construction des b&acirc;timents, c'est la matière première la plus économique mais elle est indispensable. Sa production utilise peu d'énergie.";
...
$lang['info'][14]['description']  = "Le développement de ce b&acirc;timent permet d'améliorer la vitesse de construction des b&acirc;timents, vaisseaux, défenses et recherches.";
$lang['info'][15]['name']         = "Usine de Nanites";
$lang['info'][15]['description']  = "Une amélioration deux fois plus puissante de l'usine de robot qui divise en deux le temps de construction des b&acirc;timents ainsi que des vaisseaux à chaque niveau.";
...
$lang['info'][22]['description']  = "Votre silo a une capacité réduite, investissez dans un silo plus grand pour stocker d'avantage de metal. Attention si votre silo est plein, la production de metal s'arr&ecirc;te instantanément !";
$lang['info'][23]['name']         = "Silo de cristal";
$lang['info'][23]['description']  = "Votre silo a une capacité réduite, investissez dans un silo plus grand pour stocker d'avantage de cristal. Attention si votre silo est plein, la production de cristal s'arr&ecirc;te instantanément !";
$lang['info'][24]['name']         = "Entrep&ocirc;t de deuterium";
$lang['info'][24]['description']  = "Votre entrep&ocirc;t a une capacité réduite, investissez dans un entrep&ocirc;t plus grand pour stocker d'avantage de Deuterium. Attention si votre entrep&ocirc;t est plein, la production de deuterium s'arr&ecirc;te instantanément !";
$lang['info'][31]['name']         = "Centre de recherche";
$lang['info'][31]['description']  = "Le centre de recherche est nécessaire pour développer de nouvelles technologies. En construisant les niveaux supérieurs de ce b&acirc;timent vous faites accélérer le temps de construction de vos technologies.";
$lang['info'][33]['name']         = "Terraformeur";
$lang['info'][33]['description']  = "Le développement continu des planètes a soulevé rapidement la question de la limitation de l'espace vital. Les méthodes de construction souterraine et en surface se sont averées insuffisantes. Un petit groupe composé de physiciens en énergie et d'ingénieurs en technologie de nanites a finalement trouvé la solution: la terraformation.<br>Le terraformeur peut rendre habitable des contrées entieres ou m&ecirc;me des continents en utilisant de gigantesques quantités d'énergie. Des nanites specialement développées, assurant une qualité constante du sol, sont produites continuellement dans ce bâtiment.<br><br>Une fois construit, le terraformeur ne peut &ecirc;tre détruit.";
$lang['info'][34]['name']         = "Dép&ocirc;t de ravitaillement";
$lang['info'][34]['description']  = "Le dép&ocirc;t de ravitaillement permet le stationnement prolongé des flottes d'autres membres de l'alliance ou des flottes de membres de votre liste d'amis pour augmenter la défense d'une planète. Les flottes restent en orbite et recoivent le carburant nécessaire. Chaque niveau du dép&ocirc;t permet de livrer 10.000 unités de deutérium supplémentaire aux vaisseaux en orbite.";

// ----------------------------------------------------------------------------------------------------------
// Batiments Lune!
$lang['info'][41]['name']         = "Base lunaire";
$lang['info'][41]['description']  = "Une lune n'ayant pas d'atmosphère, une base lunaire est nécessaire pour pouvoir commencer la colonisation. Celle-ci crée une atmosphère et une gravité artificielle et maintient l'atmosphère à une température supportable. Une base plus grande augmente la surface couverte par la biosphère. Pour chaque niveau de base lunaire, trois champs peuvent &ecirc;tre exploités jusqu'à la taille maximale de la lune.<br><br>Une fois construite, la base lunaire ne peut plus &ecirc;tre détruite.";
...
$lang['info'][121]['description'] = "Rayon mortel composé d'ions accélérés. En touchant un objet, il cause des dég&acirc;ts importants.";
...
$lang['info'][124]['description'] = "La technologie d'expédition contient diverses technologies de scan et permet aux vaisseaux de tailles différentes d'&ecirc;tre équipés de modules de recherche. Ceux-ci contiennent une base de données et un petit laboratoire mobile. Pour ne pas mettre en péril la sécurité du vaisseau, le module de recherche est équipé de son propre bloc énergétique et d'un générateur de champ énergétique, qui englobe le module de recherche en cas d'urgence.";
...
$lang['info'][401]['description'] = "Le Lanceur de missiles est une fa&ccedil;on simple et bon marché de se défendre. Comme il n'est qu'une évolution d'Armements balistiques habituelles, il n'a pas besoin de recherche. Ses faibles frais de production permettent de s'en servir pour la défense contre des petites flottes, par contre au fur et à mesure il perd de son importance. Après il ne sert qu'à intercepter des missiles. Des rumeurs existent affirmant que les militaires sont en train de développer de nouveaux lanceurs. Les installations de défense sont désactivées dès qu'elles sont trop endommagées. Après une bataille, jusqu'à 70% des systèmes endommagés peuvent &ecirc;tre réparés.";
$lang['info'][402]['name']        = "Artillerie laser léger";
$lang['info'][402]['description'] = "Pour pouvoir compenser les développements énormes de la technologie Vaisseaux, les chercheurs ont d&ucirc; développer un système de défense capable de battre des vaisseaux plus grands et mieux équipés. Ceci était la naissance du blaster léger. Le bombardement concentré de photons peut causer des dég&acirc;ts nettement plus importants que les Armements balistiques habituelles. De plus, on l'a aussi équipée d'un bouclier plus puissant pour pouvoir résister aux nouvelles classes de vaisseaux. Pour garder des frais de production raisonnables, la structure n'a pas été renforcée. Le laser léger offre une performance importante par rapport aux faibles frais et est donc est très intéressant, m&ecirc;me pour des civilisations plus développées. Les installations de défense sont désactivées dès qu'elles sont trop endommagées. Après une bataille, jusqu'à 70% des systèmes endommagés peuvent &ecirc;tre réparés.";
$lang['info'][403]['name']        = "Artillerie laser lourde";
$lang['info'][403]['description'] = "Le blaster lourd au laser est l'évolution conséquente du blaster leger au laser. La structure est renforcée et améliorée avec des nouveaux matériaux. La structure est donc plus résistante. En m&ecirc;me temps ont été aussi améliorés le système d'énergie et l'ordinateur de cible, ce qui permet de concentrer plus d'énergie sur un objet. Les installations de défense sont désactivées dès qu'elles sont trop endommagées. Après une bataille jusqu'à 70% des systèmes endommagés peuvent &ecirc;tre réparés.";
$lang['info'][404]['name']        = "Canon de Gauss";
$lang['info'][404]['description'] = "Pendant longtemps on a pensé que les Armements à projectiles seraient comme la technologie de la fusion et de l'énergie, le développement de la propulsion de hyperespace et le développement de protections améliorées resteraient antiques jusqu'à ce que la technologie de l'énergie, qui l'avait évincé à l'époque, les a remises en jeu. Le principe était déjà connu au 20ième et au 21ième siècle - le principe d'accélération de particules. Un canon de Gauss (Canon électromagnétique) n'est en fait rien d'autre qu'une version nettement plus grande du canon. Des projectiles qui pèsent des tonnes sont accélérés magnétiquement et atteignent une vitesse telle que les particules de saleté autour du projectile br&ucirc;lent et le recul fait trembler la terre. M&ecirc;me les protections et boucliers modernes ont du mal à résister à cette force, ce n'est pas rare qu'un projectile traverse complètement un objet. Les installations de défense sont désactivées dès qu'elles sont trop endommagées. Après une bataille, jusqu'à 70% des systèmes endommagés peuvent &ecirc;tre réparés.";
$lang['info'][405]['name']        = "Artillerie à ions";
$lang['info'][405]['description'] = "Au 21eme siècle existait quelque chose qui se nommait PEM. Le PEM était le pouls électromagnétique qui causait une tension supplémentaire dans chaque circuit, ce qui causait de nombreux incidents bloquants tous les appareils sensibles. à l'époque, le PEM était basé sur les missiles et les bombes, entre autre en relation avec des bombes atomiques. Ensuite, le PEM a été amélioré pour rendre des objets incapables d'agir sans les détruire et donc de les reprendre. Aujourd'hui, l'artillerie d'ions est la version la plus moderne du PEM. Elle lance une vague d'ions sur l'objet, ceci déstabilise les boucliers et les parties électroniques - tant qu'il n'y a pas de bouclier électronique. Sa puissance kinétique n'est pas importante. Les Croiseurs se servent eux aussi de la technologie d'ions, c'est d'ailleurs le seul type de vaisseau, les autres types ne disposant pas des quantités d'énergie nécessaires. Il est souvent intéressant de ne pas détruire un vaisseau mais de le paralyser. Les systèmes de défense se désactivent dès qu'ils sont trop endommagés. Après une bataille jusqu'à 70% des systèmes endommagés peuvent &ecirc;tre réparés.";
$lang['info'][406]['name']        = "Lanceur de plasma";
$lang['info'][406]['description'] = "La technologie laser a ensuite été perfectionnée, la technologie d'ions a atteint sa phase finale. On pensait qu'il serait impossible de rendre les systèmes d'Armements encore plus efficaces. La possibilité de combiner les deux systèmes a changé la situation. Déjà connue de la technologie de fusion, des lasers chauffent des particules (le plus souvent Hydrogéne) à une température extr&ecirc;me, parfois jusqu'à des millions de degrés. La technologie d'ions permet le chargement électrique des particules, les réseaux de stabilité et l'accélération des particules. En échauffant la charge, en la mettant sous pression et l'ionisant, on la lance par accélération dans l'espace en direction d'un objet. La balle de plasma est bleue et visuellement fascinante, par contre il est difficile de s'imaginer que l'équipage du vaisseau ciblé soit très heureux de la voir... Le lanceur de plasma est une des Armements les plus mena&ccedil;antes, mais cette technologie est assez chère. Les systèmes de défense se désactivent dès qu'ils sont trop endommagés. Après une bataille jusqu'à 70% des systèmes endommagés peuvent &ecirc;tre réparés.";
$lang['info'][407]['name']        = "Petit bouclier";
$lang['info'][407]['description'] = "Longtemps avant l'installation des générateurs de bouclier sur des vaisseaux, existaient déjà des générateurs géants sur la surface des planètes. Ceux-ci permettaient de couvrir les planètes avec des champs infranchissables qui pouvaient absorber des quantités énormes avant de s'effondrer. Des petites flottes d'attaques échouent souvent contre ces boucliers. Ces boucliers peuvent &ecirc;tre améliorés. Après, on peut m&ecirc;me construire un grand bouclier qui est encore plus puissant. Pour chaque planète on ne peut construire qu'un seul bouclier.";
$lang['info'][408]['name']        = "Grand bouclier";
$lang['info'][408]['description'] = "L'amélioration du petit bouclier. Il est basé sur la m&ecirc;me technologie mais peut se servir de nettement plus d'énergie pour se défendre.";
...
$lang['info'][605]['description'] = "Le constructeur est un nouveau type de b&acirc;tisseur. Son ADN a été modifiée pour lui conférer une force surhumaine. Un seul de ces \"homme\" peut construire une ville entière.<br><br>-10% de temps de construction. Niveau Max. : 3";
...
$lang['info'][610]['description'] = "L'espion est une personne énigmatique. Personne n'a jamais vu son visage réel, a moins d'&ecirc;tre déj&ageave; mort.<br><br>+5 Lvl D'espionnage. Niveau Max. : 2";
$lang['info'][611]['name']        = "Commandant";
$lang['info'][611]['description'] = "Le commandant de l'armée impériale est passé ma&icirc;tre dans l'art du maniement des flottes. Son cerveau peut calculer les trajectoires de nombreuses flotte, beaucoup plus que celle d'un humain normal.<br><br>+3 slots de flottes. Niveau Max. : 3";
...
$lang['info'][615]['description'] = "Vous avez montré que vous &ecirc;tiez le plus grand conquérant de l'univers. Il est tant pour vous de prendre la place qui vous revient.<br><br>Déblocage du Destructeur Planètaire";
