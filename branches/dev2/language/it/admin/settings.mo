...
$lang['adm_opt_game_oth_news'] = "Mostra sotto novità";
...
$lang['adm_opt_menu_link_enable']      = "Abilitare link personalizzabili ?<br> (1 = Sì, 0 = No)";  
...
$lang['enable_the_anounces']      = "Mostra annunci ?<br> (Sì = 1, No = 0)"; 
$lang['enable_the_marchand']      = "Vedi venditore ?<br> (Sì = 1, No = 0)"; 
$lang['enable_the_notes']      = "Mostra note ?<br> (Sì = 1, No = 0)"; 
$lang['multi_bot_settings']      = "Impostazioni di antiBOT"; 
$lang['bot_name_multi']      = "Nome BOT <br>(sarà visualizzato)"; 
$lang['bot_adress_multi']      = "Indirizzo di risposta del BOT <br>(sarà visualizzato)"; 
$lang['bot_ban_duration']      = "Durata del ban per l\'uso del BOT<br>(giorni)"; 
$lang['bot_active']      = "Attivazione del BOT<br>(1 = attivato, 0 = disattivato)<br>Per impostazione predefinita, il bot è disattivato.."; 
