...
$lang['emaildir_tip'] = "Cette adresse peut &ecirc;tre changée à tout moment. L'adresse deviendra permanente s'il n'y a pas de changemements pendant les 7 jours qui suivent.";
...
$lang['untoggleip_tip'] = "La vérification d'IP signifie qu'on effectuera un logout de sécurité automatiquement quand il y aura un changement  d'IP ou quand 2 personnes entreront sur le m&ecirc;me compte en utilisant différentes IPs. Activer la vérification d'IP peut &ecirc;tre un atout de sécurité !";
