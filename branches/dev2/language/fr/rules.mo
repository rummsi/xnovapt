...
$lang['AccountText2'] = 'Un compte n\'a le droit d\'&ecirc;tre joué que par une seule personne.';

$lang['MultiAccountText']  = 'Jouer plus d\'un compte par univers est strictement interdit.';
$lang['MultiAccountText2'] = 'Si 2 joueurs ou plus se partagent la m&ecirc;me adresse IP (membres d\'une m&ecirc;me famille, couples, écoles etc), il ne doit y avoir aucun autre point commun entre ces comptes (faire partie de la m&ecirc;me alliance est toléré), ceci pouvant &ecirc;tre considéré comme du multi compte et étant passible d\'un blocage.';
...
$lang['SittingText2'] = 'Un compte ne peut &ecirc;tre sitté que pour 12 heures consécutives.';
$lang['SittingText3'] = 'L\'opérateur de l\'univers doit impérativement &ecirc;tre informé par mail de ce sitting.';
...
$lang['SittingText5'] = 'Avant que le compte puisse &ecirc;tre resitté, il doit y avoir login du propriétaire du compte.';
