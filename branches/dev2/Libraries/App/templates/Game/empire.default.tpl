            ...
            <table border="0" cellpadding="0" cellspacing="1" width="750">
                <tbody>
                    ...
                    <tr height="20">
                        ...
                        {foreach $planet as $p}
                            <th width="75">
                                [<a href="game.php?page=galaxy&action=3&galaxy={$p['galaxy']}&system={$p['system']}">{$p['galaxy']}:{$p['system']}:{$p['planet']}</a>]
                            </th>
                        {/foreach}
                    </tr>
                    <tr height="20">
                    ...
                    <tr height="20">
                        ...
                        {foreach $planet as $p}
                            <th width="75">
                                <a href="game.php?page=resources&cp={$p['id']}&amp;re=0&amp;planettype={$p['planet_type']}">
                            ...
                            <th width="75">
                                    {if (in_array($i, $reslist['build']))}
                                        {if $p[$resource[$i]]    == 0}
                                            -
                                        {else}
                                            <a href="game.php?page=buildings&cp={$p['id']}&amp;re=0&amp;planettype={$p['planet_type']}">
                                                {$p[$resource[$i]]}
                                            </a>
                                        {/if}
                                    {/if}
                                ...
                                <th width="75">
                                    {if (in_array($i, $reslist['tech']))}
                                        {if $user[$resource[$i]]    == 0}
                                            -
                                        {else}
                                            <a href="game.php?page=buildings&mode=research&cp={$p['id']}&amp;re=0&amp;planettype={$p['planet_type']}">
                                                {$user[$resource[$i]]}
                                            </a>
                                        {/if}
                                    {/if}
                                ...
                                <th width="75">
                                    {if (in_array($i, $reslist['fleet']))}
                                        {if $p[$resource[$i]] ==0}
                                            -
                                        {else}
                                            <a href="game.php?page=buildings&mode=fleet&cp={$p['id']}&amp;re=0&amp;planettype={$p['planet_type']}">
                                                {$p[$resource[$i]]}
                                            </a>
                                        {/if}
                                    {/if}
                                ...
                                <th width="75">
                                    {if (in_array($i, $reslist['defense']))}
                                        {if $p[$resource[$i]] ==0}
                                            -
                                        {else}
                                            <a href="game.php?page=buildings&mode=defense&cp={$p['id']}&amp;re=0&amp;planettype={$p['planet_type']}">
                                                {$p[$resource[$i]]}
                                            </a>
                                        {/if}
                                    {/if}
