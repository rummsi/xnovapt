...
$lang['Fix_welldone']           = "La mise à jour n'a pu &ecirc;tre effectué.";
...
$lang['adm_rz_text']  = "En appuyant sur Accepter, vous remettrez à zéro votre Univers. Seul les comptes ne sont pas effacées. Cette opération ne peut pas &ecirc;tre annulé par la suite, il est donc conseillé d'avoir une sauvegarde de votre base de donnée!";
